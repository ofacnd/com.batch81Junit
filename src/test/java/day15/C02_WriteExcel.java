...
public class C02_WriteExcel {
    ...
    public void deleteExcelCell() throws IOException {
        ...
        workbook.getSheet("Sayfa1").getRow(0).createCell(4).setCellValue("Nufus");
                         //Sayfa1`de    0`inci satira   4. hucreye     nufus sutunu        ekliyoruz..
        ...
        // Excel dosyamiza veri girisi yaptiktan sonra dosyayi akisa aldigimiz gibi sonlandirmamiz gerekiyor.
        //SOnrasinda da workbook objemize kayit etmemiz gerekiyor.
